...
def test_duration_to_datetime_short():
    assert utils.duration_to_datetime_short(32) == "01j04h"
...
def test_convert_seconds_to_hours_minutes():
    assert utils.convert_seconds_to_hours_minutes(7800) == "02h10"

def test_convert_to_24_hours_format():
    assert utils.convert_to_24_hours_format("2025-01-01T15:00:00.0") == "15h00"